...
const integrationCategories = [
	...
	},
	{
		...
		name: 'Dev & CI/CD',
		icon: Code,
		description: 'Collect evidence from your development workflow.',
		integrations: [
			{ name: 'GitHub', description: 'Repository settings, branch protection, scan results' },
			{ name: 'GitLab', description: 'Pipeline status, security findings, access controls' },
			{ name: 'Jenkins', description: 'Build logs, deployment records' },
			{ name: 'Bitbucket', description: 'Repository permissions, PR approvals' }
		]
	},
	{
		id: 'ticketing',
	...
	},
	{
		...
		name: 'Data & Storage',
		icon: Database,
		description: 'Monitor data access and security controls.',
		integrations: [
			{ name: 'MongoDB Atlas', description: 'Access logs, encryption status' },
			{ name: 'PostgreSQL', description: 'Audit logs, permission reports' },
			{ name: 'Snowflake', description: 'Access history, security policies' }
		]
	}
]
		...
		<div className="page integrations-page">
			...
			<section className="integrations-hero">
				<div className="container">
					...
					<p>Automate evidence collection from 50+ integrations across cloud, identity, dev tools, and security.</p>
				</div>
			</section>
				...
				<div className="container">
					<div className="custom-integration card">
						<div className="custom-integration-content">
							...
							<p>We support custom integrations via our API and webhook system. Our team can help you connect any data source.</p>
